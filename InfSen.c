...
{
    uint8_t ui8Value = 0;
    if (GPIOPinRead(IN_SEN_1_PORT, IN_SEN_1_PIN)) ui8Value += 1;
    if (GPIOPinRead(IN_SEN_2_PORT, IN_SEN_2_PIN)) ui8Value += 2;
    if (GPIOPinRead(IN_SEN_3_PORT, IN_SEN_3_PIN)) ui8Value += 4;
    if (GPIOPinRead(IN_SEN_4_PORT, IN_SEN_4_PIN)) ui8Value += 8;
    if (GPIOPinRead(IN_SEN_5_PORT, IN_SEN_5_PIN)) ui8Value += 16;
    return ui8Value;
}
